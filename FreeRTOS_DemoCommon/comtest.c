...
static portTASK_FUNCTION_PROTO( vComTxJeremTask, pvParameters );
...
void vAltStartComTestTasks( UBaseType_t uxPriority, uint32_t ulBaudRate, UBaseType_t uxLED )
{
	...
	xTaskCreate( vComTxTask, "COMTx", comSTACK_SIZE, NULL, uxPriority - 1, ( TaskHandle_t * ) NULL );
        xTaskCreate( vComTxJeremTask, "COMTx2", comSTACK_SIZE, NULL, uxPriority , ( TaskHandle_t * ) NULL );
...
static portTASK_FUNCTION( vComTxJeremTask, pvParameters )
{
char cByteToSend;
TickType_t xTimeToWait;
